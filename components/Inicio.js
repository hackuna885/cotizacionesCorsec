                ...
                <div class="col-md-6 mx-auto">
                    ...
                    <div class="mx-2 mx-md-5 my-md-5 my-3">
                        ...
                        <form @submit.prevent="controlLogin">
                            ...
                            <button class="btn btn-primary form-control form-control-user my-3" type="submit" :disabled="this.txtCorreo != '' && this.txtPws.length >= 6 ? this.estadoBtn = false : this.estadoBtn = true" style="font-size: 1.2em; font-weight: bolder;">Inicio</button>
                        </form>
                        <hr>
            ...
            <div class="row justify-content-center align-items-center vh-100">
                ...
                <div class="col-md-6 mx-auto">
                    ...
                    <div class="mx-2 mx-md-5 my-md-5 my-3">
                        ...
                        <p>Por favor, introduzca su dirección de correo electrónico a continuación y le enviaremos un enlace para restablecer su contraseña.</p>
            ...
            .then(response => {
              if (response.data === 'correcto') {
                  Swal.fire({
                      ...
                      timer: 2000,
                      onClose: () => {  
                        window.location="/cotizacionesCorsec";
                      }
                  })
              }else{
                  this.datos = response.data
